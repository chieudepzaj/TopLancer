                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-with-icon-left no-border">
                                        ...
                                        <input class="input-text" type="text" placeholder="<?php _e("Your Name") ?> *"
                                            name="user_name" value="<?php _esc($user_name) ?>" required="">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="input-with-icon-left no-border">
                                        ...
                                        <input class="input-text" type="email"
                                            placeholder="<?php _e("Your E-Mail") ?> *" name="user_email"
                                            value="<?php _esc($user_email) ?>" required>
                                    </div>
                                </div>
