                                    ...
                                    <div class="payment-tab-content">
                                        ...
                                        <div class="row premium-plans">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                <?php _esc($featured_fee)?> <?php _esc($user_currency_sign)?> <?php _e("for") ?> <?php _esc($featured_duration)?> <?php _e("days") ?>
                                            </div>
                                        </div>
                                        <div class="row premium-plans">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                <?php _esc($urgent_fee)?> <?php _esc($user_currency_sign)?> <?php _e("for") ?> <?php _esc($urgent_duration)?> <?php _e("days") ?>
                                            </div>
                                        </div>
                                        <div class="row premium-plans">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3 premium-plans-price">
                                                <?php _esc($highlight_fee)?> <?php _esc($user_currency_sign)?> <?php _e("for") ?> <?php _esc($highlight_duration)?> <?php _e("days") ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
