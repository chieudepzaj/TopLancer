        ...
        <div class="col-xl-8 col-lg-8 content-right-offset">
            ...
            <div class="job-header">
                <div class="header-image"><img
                        src="<?php _esc($config['site_url'])?>storage/products/<?php _esc($item_image)?>"
                        alt="<?php _esc($item_title)?>"></div>
        ...
        <div class="col-xl-4 col-lg-4">
            <div class="sidebar-container">
                ...
                <div class="sidebar-widget">
                    ...
                    <!-- Bookmark Button -->
                    <button
                        class="bookmark-button fav-button margin-bottom-25 set-item-fav <?php if($item_favorite == '1'){ echo 'added'; } ?>"
                        data-item-id="<?php _esc($item_id)?>" data-userid="<?php _esc($user_id)?>" data-post-type="job"
                    ...
                    <div class="share-buttons margin-top-25">
                        ...
                        <div class="share-buttons-content">
                            ...
                            <ul class="share-buttons-icons">
                                <li><a href="mailto:?subject=<?php _esc($item_title)?>&body=<?php _esc($item_link)?>"
                        ...
                        <div class="job-listing-details">
                            <div class="job-listing-company-logo">
                                <img src="<?php _esc($config['site_url'])?>storage/products/<?php _esc($item['image'])?>"
                                    alt="<?php _esc($item['company_name'])?>">
                            </div>
            ...
            <form method="post" action="" accept-charset="UTF-8" enctype="multipart/form-data">
                ...
                <div class="submit-field">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="radio">
                                <input id="resume-<?php _esc($resume['id'])?>" name="resume" class="resume-file"
                                    type="radio" value="<?php _esc($resume['id'])?>">
                                <label for="resume-<?php _esc($resume['id'])?>"><span class="radio-label"></span>
                                    <?php _esc($resume['name'])?> - <a
                                        href="<?php _esc($config['site_url'])?>storage/resumes/<?php _esc($resume['filename'])?>"
                                        download=""><?php _e("Download") ?></a></label>
                            </div>
                        </li>
                        <?php } ?>
                        <li>
                            <div class="radio">
                                <input id="resume-0" name="resume" class="new-resume resume-file" type="radio" value="0"
                                    checked>
                                <label for="resume-0"><span class="radio-label"></span>
                                    <?php _e("Add New Resume") ?></label>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="uploadButton resume-upload-button">
                    ...
                    <span
                        class="uploadButton-file-name"><?php _e("Only pdf, doc, docx, rtf, rtx, ppt, pptx, jpeg, jpg, bmp, png file types allowed.") ?></span>
                </div>
                <?php }?>
                <button class="button margin-top-35 full-width button-sliding-icon ripple-effect" name="submit"
                    type="submit"><?php _e("Apply Now") ?> <i class="icon-feather-arrow-right"></i></button>
            </form>
            <?php }else{?>
